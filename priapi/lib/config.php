...
// 定義済みユーザー
define('ADMIN_ID',                              1);
define('ADMIN_ACCOUNT',                         'admin@starship.jp');
define('ADMIN_PASSWORD',                        Env('ADMIN_PASSWORD'));
define('GUEST_ID',                              2);
define('GUEST_ACCOUNT',                         'guest@starship.jp');
define('GUEST_PASSWORD',                        Env('GUEST_PASSWORD'));

// リクエスト（TCPDetective からの）
...
define('VALIDATION_TIMEOUT_HOURS',              24);

// 開発者のアドレス
define('DEVELOPER_ADDRESS_CSV',                 Env('DEVELOPER_ADDRESS_CSV'));

// ユーザー登録確認（＝アカウント有効性確認）の結果
define('USER_REGISTRATION_CONFIRMED',   1);
define('USER_REGISTRATION_DENIED',      0);
...
// クライアント（www.starship.jp の管理画面）サイトの URI を作成する
...
// クライアント（www.starship.jp の管理画面）サイトのサポートページの URI を作成する
